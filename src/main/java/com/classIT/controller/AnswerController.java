...
public class AnswerController {
	...
	// ´ñ±Û »èÁ¦
	@DeleteMapping(value="/remove/{answer_no}/{user_id}",  produces = {MediaType.TEXT_PLAIN_VALUE})
	public ResponseEntity<String> remove(@PathVariable Long answer_no,@PathVariable String user_id){
		log.info("////////////////////////////////remove : " + answer_no + ", " + user_id);
		return service.remove(answer_no, user_id) == 1 ? new ResponseEntity<String>("success",HttpStatus.OK)
